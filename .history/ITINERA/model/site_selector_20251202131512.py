        ...
        for key, site_entry in result.get('sites', {}).items():
            try:
                ...
                site_entry['score_details'] = {
                    ...
                    'price': {'raw': price, 'normalized': price_score, 'desc': f'{price:.0f}万元'},
                    'area': {'raw': area, 'normalized': area_score, 'desc': f'{area:.0f}㎡'},
                    'region': {'raw': region, 'normalized': region, 'desc': f'{region:.1f}分'}
                }
            except:
                pass
